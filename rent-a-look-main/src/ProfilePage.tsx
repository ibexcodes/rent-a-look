            ...
            >
              ...
              {historyLoading ? (
                ...
                <div className="bg-white rounded-[2.5rem] p-20 text-center border border-black/5">
                  ...
                  <Link to="/#inventory" className="px-8 py-4 bg-black text-white rounded-full font-bold text-sm hover:bg-botswana-blue transition-all">
                    Browse Collection
                  </Link>
                </div>
              ) : (
          ...
          >
            ...
            <div className="flex gap-4">
              <button 
                ...
                className="flex-1 py-3 rounded-full font-bold bg-black/5 hover:bg-botswana-blue/10 transition-colors"
              >
                Keep Order
              </button>
              <button 
