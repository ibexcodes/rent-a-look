...
export const Footer = () => {
  return (
    <footer className="bg-[#FDFCFB] pt-20 pb-32 md:pb-10 border-t border-black/5">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-display font-black text-lg tracking-tighter leading-none uppercase">RENT-A-LOOK</span>
            ...
            <p className="text-black/60 max-w-sm mb-8">
              Nna le Styl. Spend Less. Empowering students across UB, BIUST, BSBS, Botho and beyond.
            </p>
        ...
        <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-black/40">
          <p>© 2026 RENT-A-LOOK. All rights reserved.</p>
