...
const categories = ["All", "Combo deals", "Trousers", "Wigs", "T-shirt", "Shoes", "Dresses", "Accessories", "Wedding Gowns", "Graduation Gowns"];
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${
                    activeCategory === category 
                      ? "bg-black text-white" 
                      : "bg-black/5 text-black/60 hover:bg-botswana-blue/10"
                  } shadow-sm`}
                >
                  {category}
                </button>
              ...
              {totalPages > 1 && (
                <div className="flex justify-center items-center gap-2 mt-16">
                  <button
                    ...
                    className="px-4 py-2 rounded-full bg-black/5 text-black/60 font-medium hover:bg-botswana-blue/10 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                    Previous
                  </button>
