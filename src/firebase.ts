...
export const getAuthErrorMessage = (errorCode: string): string => {
  switch (errorCode) {
    ...
    case 'auth/network-request-failed':
      return 'Network error. This can be caused by ad-blockers, firewall settings, or browser restrictions on third-party cookies in iframes. Please try disabling ad-blockers or opening the app in a new tab.';
